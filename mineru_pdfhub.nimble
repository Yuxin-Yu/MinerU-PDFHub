...
task docs, "Generate documentation":
  exec "nim doc --project --index:on --outdir:docs/generated src/mineru_pdfhub.nim"
...
task test_comprehensive, "Run comprehensive test suite":
  ...
  exec "nim c -r tests/test_mineru_pdfhub_server.nim"
...
task build, "Build the project":
  exec "nim c -o:mineru-pdfhub src/mineru_pdfhub.nim"

task clean, "Clean build artifacts":
  exec "rm -f mineru-pdfhub"
  exec "rm -rf nimcache/"
  exec "rm -rf .nimcache/"

task dev, "Run in development mode":
  exec "nim c -r -o:mineru-pdfhub src/mineru_pdfhub.nim"
